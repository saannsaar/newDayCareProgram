...
// This page is only available for worker-users, parent-users can not get to this.
// Component to render the "Daycare" page where there is information about
// the daycare and all the groups and children that are in the daycare system.
